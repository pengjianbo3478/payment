package com.gl365.payment.dto.authconsumeconfirm.response;
import java.math.BigDecimal;
import com.gl365.payment.dto.base.response.BaseResponse;
import com.gl365.payment.util.Gl365StrUtils;
import java.io.Serializable;
public class AuthConsumeConfirmRespDTO extends BaseResponse implements Serializable {
	public AuthConsumeConfirmRespDTO(String payStatus, String payDesc) {
