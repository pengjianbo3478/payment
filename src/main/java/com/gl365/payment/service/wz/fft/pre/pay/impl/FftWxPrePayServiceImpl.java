...
@Service
public class FftWxPrePayServiceImpl extends AbstractFftWxPrePay implements FftWxPrePayService {
	private static final Logger LOG = LoggerFactory.getLogger(FftWxPrePayServiceImpl.class);
