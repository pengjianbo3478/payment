package com.gl365.payment.service.wz.rm.cancel.cancel.impl;
...
import com.gl365.payment.service.wz.rm.cancel.cancel.abs.AbstractRmWxCancelBuild;
...
@Service
public class RmWxCancelServiceImpl extends AbstractRmWxCancelBuild implements RmWxCancelService {
	private static final Logger LOG = LoggerFactory.getLogger(RmWxCancelServiceImpl.class);
	@Autowired
