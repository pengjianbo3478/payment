package com.gl365.payment.service.wz.rm.reward.abs;
...
public abstract class AbstractRmWxRewardBuild extends AbstractPay{
	private static final Logger LOG = LoggerFactory.getLogger(AbstractRmWxRewardBuild.class);
	@Resource
	...
	protected void calculateCurrentPayProfit(RmWxRewardContext ctx) {
		...
		ctx.setRespDataDetails(details);
	}
