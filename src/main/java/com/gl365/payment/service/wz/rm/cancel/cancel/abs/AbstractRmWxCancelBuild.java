package com.gl365.payment.service.wz.rm.cancel.cancel.abs;
...
public abstract class AbstractRmWxCancelBuild extends AbstractPay {
	private static final Logger LOG = LoggerFactory.getLogger(AbstractRmWxCancelBuild.class);
	@Autowired
