...
@Service
public class FftWxCancelQueryServiceImpl extends AbstractFftWxCancelQuery implements FftWxCancelQueryService {
	private static final Logger LOG = LoggerFactory.getLogger(FftWxCancelQueryServiceImpl.class);
