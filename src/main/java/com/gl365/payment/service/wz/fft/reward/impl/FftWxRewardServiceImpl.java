package com.gl365.payment.service.wz.fft.reward.impl;
...
import com.gl365.payment.service.wz.fft.reward.abs.AbstractFftWxRewardBuild;
...
@Service
public class FftWxRewardServiceImpl extends AbstractFftWxRewardBuild implements FftWxRewardService {
	private static final Logger LOG = LoggerFactory.getLogger(FftWxRewardServiceImpl.class);
	@Autowired
