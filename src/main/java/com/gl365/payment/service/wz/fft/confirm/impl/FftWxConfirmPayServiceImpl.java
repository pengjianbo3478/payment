...
@Service
public class FftWxConfirmPayServiceImpl extends AbstractFftWxConfirmPay implements FftWxConfirmPayService {
	private static final Logger LOG = LoggerFactory.getLogger(FftWxConfirmPayServiceImpl.class);
