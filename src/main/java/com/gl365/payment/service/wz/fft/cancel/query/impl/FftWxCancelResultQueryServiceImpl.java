package com.gl365.payment.service.wz.fft.cancel.query.impl;
...
@Service
public class FftWxCancelResultQueryServiceImpl extends AbstractFftWxCancelResultQuery implements FftWxCancelResultQueryService {
	private static final Logger LOG = LoggerFactory.getLogger(FftWxCancelResultQueryServiceImpl.class);
